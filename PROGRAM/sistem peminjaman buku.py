...
class Sistem_peminjaman_buku:
    ...
    def hapus_buku(self,kode_buku):
        ...
        if cur.fetchall() != []:
            ...
            print(Fore.RED + '\nBuku tidak ditemukan ' + Style.RESET_ALL)
...
class peminjam:
    ...
    def pinjam_buku(self, kode_buku, nama_peminjam,judul_buku):
        self.kode_buku = kode_buku
...
while True:
    ...
    print('2.',Fore.GREEN + ' Tampil semua data buku'+ Style.RESET_ALL)
    print('3.',Fore.MAGENTA +' Cari buku'+ Style.RESET_ALL)
    print('4.',Fore.RED + ' Hapus buku'+ Style.RESET_ALL)
    print('5.',Fore.YELLOW +' Pinjam Buku'+ Style.RESET_ALL)
    print('6.', Fore.GREEN +' Tampil semua data peminjam'+ Style.RESET_ALL)
    ...
    if menu == '1':
        ...
        os.system('cls')
        judul = input('Masukan Kata Kunci Judul Buku : ')
        ...
        for i in data:
            ...
            print(f'Judul          : {i[1]}')
            print('-'*50)
        kode = int(input('\nMasukan kode Buku yang akan dipinjam: '))
        nama = input('Masukan nama: ')
        judul_buku = input('Masukan judul buku : ')
        p.pinjam_buku(kode, nama, judul_buku)
        input(Fore.YELLOW +'\nTekan Enter Untuk Melanjutkan.....')
        ...
        p.kembalikan_buku(kode_buku,id_peminjam)
        input(Fore.YELLOW +'\nTekan Enter Untuk Melanjutkan.....')
